...
class BamlAsyncClient:
    ...
    async def ExtractObjectActionPairs(
        self,
        labels: List[str],
        baml_options: BamlCallOptions = {},
...
class BamlStreamClient:
    ...
    def CategorizeProcess(
        ...
        activities: List[str],model_name: str,categories: List[str],process_id: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.CategorizedProcess, types.CategorizedProcess]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.CategorizedProcess, types.CategorizedProcess](
        raw,
    ...
    def ExtractObjectActionPairs(
        ...
        labels: List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.ExtractedPairs, types.ExtractedPairs]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.ExtractedPairs, types.ExtractedPairs](
        raw,
